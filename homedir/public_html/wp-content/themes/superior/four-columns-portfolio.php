<?php
// Template Name: Four Columns Portfolio 
get_header(); 
?>
...
<div class="container">
  ...
  <div class="row">
        ...
        $ploop = new WP_Query(array( 'post_type' => 'portfolio', 'posts_per_page' => $data['te_portfolio_items'],  'paged' => $paged ) );
          ...
          ?>
            <div class="portfolio-item portfolio-4col <?php foreach ($terms as $term) { echo strtolower(preg_replace('/\s+/', '-', $term->name)). ' '; } ?>">
              <?php
              $thumb = get_post_thumbnail_id();
              $img_url = wp_get_attachment_url( $thumb,'full' ); //get full URL to image (use "large" or "medium" if the images too big)
              $image = aq_resize( $img_url, 620, 546, true ); //resize & crop the image  
            ?>
              <div class="item-dec">    
                <div class="item-img">
