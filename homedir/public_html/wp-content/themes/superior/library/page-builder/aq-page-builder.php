...
if(!defined('AQPB_PATH')) define( 'AQPB_PATH', get_template_directory(). '/library/page-builder/' );
if(!defined('AQPB_DIR')) define( 'AQPB_DIR', get_template_directory_uri(). '/library/page-builder/' );
...
aq_register_block('Heading_Block');
aq_register_block('Big_title');
aq_register_block('big_tagline_Block');
aq_register_block('Progress_Bars_Block');
aq_register_block('Client_Logo');
aq_register_block('Recentpost_Slide');
aq_register_block('Recentwork_Slide');
aq_register_block('Recent_post');
aq_register_block('gmap');
aq_register_block('contactform');
aq_register_block('team_person');
aq_register_block('HeadingStyle3_Block');
aq_register_block('Service_box');
aq_register_block('Service_box_style2');
aq_register_block('fact_box');
aq_register_block('skill_circle');
aq_register_block('Recentwork_Slider');
aq_register_block('Thumb_Expanding_work');
aq_register_block('dynamic_grid_portfolio');
aq_register_block('Grid_blog');
aq_register_block('flexslider');
