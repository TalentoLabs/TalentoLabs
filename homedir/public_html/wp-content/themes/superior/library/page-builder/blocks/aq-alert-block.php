...
if(!class_exists('AQ_Alert_Block')) {
	class AQ_Alert_Block extends AQ_Block {
		...
		function block($instance) {
			...
			echo '<div class="alert alert-'.$type.' fade in style="'. $style .'"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">x</button>' . do_shortcode(htmlspecialchars_decode($content)) . '</div>';
