...
if(!class_exists('AQ_Block')) {
	class AQ_Block {
	 	...
	 	function before_block($instance) {
            ...
            $col_size = preg_replace("/[^\d]/", "", $size);
  
            if ($id_base == 'slider'){
	 		echo "";
	 		} 
			
			elseif ($id_base == 'slides')
			{
            echo "";
			}
	 		...
	 		echo '<div id="aq-block-'.$template_id.'-'.$number.'" class="aq-block aq-block-'.$id_base.' col-md-'.$col_size.' '.$column_class.' clearfix">';
	 	...
	 	function after_block($instance) {
			...
			if ($size == 'span12'){
	 		$column_class = $first ? 'no-aq-first' : '';
	 		} 
