...
--
-- WHERE:  owner_id='ntrieb' or owner_id REGEXP '@(talento\-labs\.com)$'
...
--
-- WHERE:  pref_uid='ntrieb' or pref_uid REGEXP '@(talento\-labs\.com)$'
...
--
-- WHERE:  share_owner='ntrieb' or share_owner REGEXP '@(talento\-labs\.com)$'
...
--
-- WHERE:  vfb_owner='ntrieb' or vfb_owner REGEXP '@(talento\-labs\.com)$'
...
--
-- WHERE:  memo_owner='ntrieb' or memo_owner REGEXP '@(talento\-labs\.com)$'
...
--
-- WHERE:  task_owner='ntrieb' or task_owner REGEXP '@(talento\-labs\.com)$'
